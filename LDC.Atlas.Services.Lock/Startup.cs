...
using LDC.Atlas.Services.Lock.Infrastructure.Mapping;
using LDC.Atlas.Services.Lock.Infrastructure.Modules;
using LDC.Atlas.Services.Lock.Infrastructure.Policies;
using MediatR;
...
[assembly: AtlasServiceAssembly(AtlasServiceNames.Lock)]

namespace LDC.Atlas.Services.Lock
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddLockAuthorizationPolicies();
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                {
                    c.SwaggerDoc("v1", new Info { Title = "Lock API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint(apiRoot + $"/api/v1/lo{serviceNamespace}ck/swagger/v1/swagger.json", "Lock V1");
                });
            }
