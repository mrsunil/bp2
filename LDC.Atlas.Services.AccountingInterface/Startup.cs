...
using LDC.Atlas.Services.AccountingInterface.Infrastructure.Mapping;
using LDC.Atlas.Services.AccountingInterface.Infrastructure.Modules;
using LDC.Atlas.Services.AccountingInterface.Infrastructure.Policies;
...
[assembly: AtlasServiceAssembly(AtlasServiceNames.AccountingInterface)]
namespace LDC.Atlas.Services.AccountingInterface
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<ESBSettings>(Configuration.GetSection("ESBConfiguration"));
            ...
            services.AddAccountingInterfaceAuthorizationPolicies();
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                {
                    c.SwaggerDoc("v1", new Info { Title = "AccountingInterface API", Version = "v1" });
            ...
            // Register types from LDC.Atlas.Audit.Common
            containerBuilder.RegisterModule(new Atlas.Audit.Common.MediatorModule());
        ...
        {
            var serviceNamespace = "accountinginterface";
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint(apiRoot + $"/api/v1/{serviceNamespace}/swagger/v1/swagger.json", "AccountingInterface V1");
                });
            }
