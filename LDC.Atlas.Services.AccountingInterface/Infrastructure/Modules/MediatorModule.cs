...
namespace LDC.Atlas.Services.AccountingInterface.Infrastructure.Modules
{
    public class MediatorModule : Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<Services.ESBService>().AsImplementedInterfaces().PropertiesAutowired();
