...
using LDC.Atlas.Services.UserIdentity.Infrastructure.Mapping;
using LDC.Atlas.Services.UserIdentity.Infrastructure.Modules;
using LDC.Atlas.Services.UserIdentity.Infrastructure.Policies;
...
[assembly: AtlasServiceAssembly(AtlasServiceNames.UserIdentity)]

namespace LDC.Atlas.Services.UserIdentity
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Audience = Configuration["OAuth2:ClientId"];
            ...
            // Replace general purpose PrivilegeProvider to LocalPrivilegeProvider
            // Leave this line BEFORE the AddAtlasAuthorizationServices call
            // services.AddScoped<IPrivilegeProvider, LocalPrivilegeProvider>();
            ...
            services.AddTradeAuthorizationPolicies();

            // Register Hosted Services
            services.AddTransient<Atlas.Infrastructure.Services.Logging.ILogger, Atlas.Infrastructure.Services.Logging.ApplicationInsightsLogger>();
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                {
                    c.SwaggerDoc("v1", new Info { Title = "UserIdentity API", Version = "v1" });
        ...
        {
            var serviceNamespace = "useridentity";
            ...
            // This middleware helps to get the company parameter from the route
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint(apiRoot + $"/api/v1/{serviceNamespace}/swagger/v1/swagger.json", "UserIdentity V1");
                });
            }
