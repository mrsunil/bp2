...
using LDC.Atlas.Services.Freeze.Infrastructure.Mapping;
using LDC.Atlas.Services.Freeze.Infrastructure.Modules;
...
[assembly: AtlasServiceAssembly(AtlasServiceNames.Freeze)]

namespace LDC.Atlas.Services.Freeze
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddFreezeAuthorizationPolicies();
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                {
                    c.SwaggerDoc("v1", new Info { Title = "Freeze API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint(apiRoot + $"/api/v1/{serviceNamespace}/swagger/v1/swagger.json", "Freeze V1");
                });
            }
