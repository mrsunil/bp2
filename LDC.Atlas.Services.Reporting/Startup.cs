...
using LDC.Atlas.Services.Reporting.Infrastructure.Mapping;
using LDC.Atlas.Services.Reporting.Infrastructure.Modules;
...
[assembly: AtlasServiceAssembly(AtlasServiceNames.Reporting)]

namespace LDC.Atlas.Services.Reporting
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                {
                    c.SwaggerDoc("v1", new Info { Title = "Reporting API", Version = "v1" });
        ...
        {
            var serviceNamespace = "reporting";
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint(apiRoot + $"/api/v1/{serviceNamespace}/swagger/v1/swagger.json", "Reporting V1");
                });
            }
