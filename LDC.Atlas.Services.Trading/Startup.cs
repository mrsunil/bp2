...
using LDC.Atlas.Document.Common.HealthChecks.DependencyInjection;
...
using LDC.Atlas.Services.Trading.Infrastructure.Mapping;
...
[assembly: AtlasServiceAssembly(AtlasServiceNames.Trading)]
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("LDC.Atlas.Services.Trading.Test")]
namespace LDC.Atlas.Services.Trading
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ITagFieldsQueries, TagFieldsQueriesFixed>();
            ...
            services.AddScoped<IAuthorizationHandler, DeleteCostsTradePhysicalHandler>();
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                {
                    c.SwaggerDoc("v1", new Info { Title = "Trade API", Version = "v1" });
            ...
            containerBuilder.RegisterModule(new Infrastructure.Modules.MediatorModule());
            ...
            // Register types from LDC.Atlas.MasterData.Common
            containerBuilder.RegisterModule(new LDC.Atlas.Execution.Common.MediatorModule());
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint(apiRoot + $"/api/v1/{serviceNamespace}/swagger/v1/swagger.json", "Trading V1");
                });
            }
