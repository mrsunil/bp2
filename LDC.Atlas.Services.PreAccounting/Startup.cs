...
using LDC.Atlas.Services.PreAccounting.Infrastructure.Mapping;
...
[assembly: AtlasServiceAssembly(AtlasServiceNames.PreAccounting)]
...
namespace LDC.Atlas.Services.PreAccounting
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddPreaccountingAuthorizationPolicies();
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                {
                    c.SwaggerDoc("v1", new Info { Title = "PreAccounting API", Version = "v1" });
        ...
        {
            var serviceNamespace = "preaccounting";
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint(apiRoot + $"/api/v1/{serviceNamespace}/swagger/v1/swagger.json", "PreAccounting V1");
                });
            }
