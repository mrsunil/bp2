...
using LDC.Atlas.Services.Document.Infrastructure.Mapping;
using LDC.Atlas.Services.Document.Infrastructure.Modules;
...
[assembly: AtlasServiceAssembly(AtlasServiceNames.Document)]

namespace LDC.Atlas.Services.Document
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDocumentAuthorizationPolicies();

            services.AddScoped<IDapperContext, DapperContext>();
            services.AddScoped<IUnitOfWork, DapperUnitOfWork>();
            services.AddScoped<IContextInformation, ContextInformation>();
            services.AddScoped<ITemplateParametersQueries, TemplateParametersQueriesFixed>();

            services.AddScoped<HttpClient>();

            services.AddTransient<ISharePointService, SharePointService>();
            services.AddTransient<ITagServiceForContractAdvice, TagServiceForContractAdvice>();
            services.AddTransient<IGraphClientProvider, GraphClientProvider>();
            ...
            containerBuilder.RegisterModule(new Atlas.Document.Common.MediatorModule());
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint(apiRoot + $"/api/v1/{serviceNamespace}/swagger/v1/swagger.json", "Document V1");
                });
            }
