...
using LDC.Atlas.Services.GenericBackInterface.Extensions;
using LDC.Atlas.Services.GenericBackInterface.Infrastructure.Mapping;
using LDC.Atlas.Services.GenericBackInterface.Infrastructure.Modules;
using LDC.Atlas.Services.GenericBackInterface.Infrastructure.Policies;
using MediatR;
...
[assembly: AtlasServiceAssembly(AtlasServiceNames.GenericBackInterface)]
namespace LDC.Atlas.Services.GenericBackInterface
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            // Configure settings
            services.Configure<AtlasApplicationSettings>(Configuration.GetSection("AtlasApplication"));
            services.AddOptions();
            ...
            services.AddGenericBackInterfaceAuthorizationPolicies();
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                {
                    c.SwaggerDoc("v1", new Info { Title = "GenericBackInterface API", Version = "v1" });
            ...
            containerBuilder.RegisterModule(new Application.Common.MediatorModule());
        ...
        {
            var serviceNamespace = "genericbackinterface";
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint(apiRoot + $"/api/v1/{serviceNamespace}/swagger/v1/swagger.json", "GenericBackInterface V1");
                });
            }
