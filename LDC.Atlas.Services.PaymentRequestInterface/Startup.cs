...
using LDC.Atlas.Services.PaymentRequestInterface.Infrastructure.Mapping;
using LDC.Atlas.Services.PaymentRequestInterface.Infrastructure.Modules;
using MediatR;
...
[assembly: AtlasServiceAssembly(AtlasServiceNames.PaymentRequestInterface)]
namespace LDC.Atlas.Services.PaymentRequestInterface
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                {
                    c.SwaggerDoc("v1", new Info { Title = "PaymentRequestInterface API", Version = "v1" });
        ...
        {
            var serviceNamespace = "paymentrequestinterface";
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint(apiRoot + $"/api/v1/{serviceNamespace}/swagger/v1/swagger.json", "PaymentRequestInterface V1");
                });
            }
