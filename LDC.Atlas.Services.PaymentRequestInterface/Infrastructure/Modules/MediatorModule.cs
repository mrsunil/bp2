...
namespace LDC.Atlas.Services.PaymentRequestInterface.Infrastructure.Modules
{
    public class MediatorModule : Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<Services.PaymentRequestService>().AsImplementedInterfaces().PropertiesAutowired();
