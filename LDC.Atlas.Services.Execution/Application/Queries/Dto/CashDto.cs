...
{
    public class CashDto : PaginatedItem
    {
        ...
        public string TraxInterfaceStatus { get; set; }
        ...
        public IEnumerable<AdditionalCostDto> AdditionalCostDetails { get; set; }
        ...
        public IEnumerable<CashMatchingDto> DocumentMatchings { get; set; }
