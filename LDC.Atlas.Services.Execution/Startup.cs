...
using LDC.Atlas.Services.Execution.Infrastructure.Mapping;
using LDC.Atlas.Services.Execution.Infrastructure.Modules;
...
[assembly: AtlasServiceAssembly(AtlasServiceNames.Execution)]
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("LDC.Atlas.Services.Execution.Tests")]

namespace LDC.Atlas.Services.Execution
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                {
                    c.SwaggerDoc("v1", new Info { Title = "Execution API", Version = "v1" });
        ...
        {
            var serviceNamespace = "execution";
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint(apiRoot + $"/api/v1/{serviceNamespace}/swagger/v1/swagger.json", "Execution V1");
                });
            }
