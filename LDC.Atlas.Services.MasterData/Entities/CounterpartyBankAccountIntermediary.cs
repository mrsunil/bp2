...
{
    public class CounterpartyBankAccountIntermediary
    {
        public long? BankAccountIntermediaryId { get; set; }
        ...
        public long? ParentBankAccountId { get; set; }
        ...
        public int TempParentBankAccountId { get; set; }
    }
}
