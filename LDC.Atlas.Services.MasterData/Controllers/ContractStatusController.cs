...
namespace LDC.Atlas.Services.MasterData.Controllers
{
    ...
    public class ContractStatusController : ControllerBase
    {
        ...
        public ContractStatusController(IUnitOfWork unitOfWork, IContractStatusRepository contractStatusRepository)
        {
        ...
        /// <summary>
        /// Returns the list of contract status.
        /// </summary>
        ...
        {
            IEnumerable<EnumEntity> contractStatus = await _contractStatusRepository.GetAllAsync(company);

            var response = new CollectionViewModel<EnumEntity>(contractStatus.ToList());
