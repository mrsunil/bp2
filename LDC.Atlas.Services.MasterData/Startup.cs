...
using LDC.Atlas.Services.MasterData.Infrastructure.Mapping;
...
[assembly: AtlasServiceAssembly(AtlasServiceNames.MasterData)]

namespace LDC.Atlas.Services.MasterData
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMasterDataAuthorizationPolicies();
            ...
            // Register all Handlers and Master in a given assembly.
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                {
                    c.SwaggerDoc("v1", new Info { Title = "MasterData API", Version = "v1" });
            ...
            containerBuilder.RegisterModule(new Atlas.MasterData.Common.MediatorModule());
        ...
        {
            var serviceNamespace = "masterdata";
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint(apiRoot + $"/api/v1/{serviceNamespace}/swagger/v1/swagger.json", "MasterData V1");
                });
            }
