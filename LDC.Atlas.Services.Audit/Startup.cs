...
using LDC.Atlas.Services.Audit.Infrastructure.Mapping;
using LDC.Atlas.Services.Audit.Infrastructure.Modules;
...
[assembly: AtlasServiceAssembly(AtlasServiceNames.Audit)]
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("LDC.Atlas.Services.Audit.Tests")]
namespace LDC.Atlas.Services.Audit
{
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            if (Configuration["SwaggerGen"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint(apiRoot + $"/api/v1/{serviceNamespace}/swagger/v1/swagger.json", "Audit V1");
                });
            }
